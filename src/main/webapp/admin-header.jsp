        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="list-user?type=environment">Hội thảo môi trường</a>
                    <a class="collapse-item" href="list-user?type=technology">Hội thảo công nghệ</a>
                    <a class="collapse-item" href="list-user?type=science">Hội thảo khoa học</a>
                </div>
            </div>
        </li>
